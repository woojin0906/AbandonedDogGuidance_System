...
public class myWriterVolunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_writer_volun);
        ...
        mDatabaseRef.child("VolunteerInfoWriter").child(UserId).limitToLast(100).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Log.e("myWriterVolunActivity", String.valueOf(databaseError.toException()));
            }
        });

        adapter = new MyWriterVolunAdapter(arrayList, this);
