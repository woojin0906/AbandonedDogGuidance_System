...
public class MyWriterVolunAdapter extends RecyclerView.Adapter<MyWriterVolunAdapter.CustomViewHolder> {

    private ArrayList<VolunteerInfo> arrayList;
    private Context context;

    public MyWriterVolunAdapter(ArrayList<VolunteerInfo> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((myWriterVolunActivity)context).startActivity(intent);
            }
        });
    }
