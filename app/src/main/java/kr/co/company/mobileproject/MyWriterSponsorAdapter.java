...
public class MyWriterSponsorAdapter extends RecyclerView.Adapter<MyWriterSponsorAdapter.CustomViewHolder> {

    private ArrayList<SponsorInfo> arrayList;
    private Context context;

    public MyWriterSponsorAdapter(ArrayList<SponsorInfo> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((myWriterSponsorActivity)context).startActivity(intent);
            }
        });
    }
