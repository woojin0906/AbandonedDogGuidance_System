...
public class SponsorCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(comment.equals("")) {
                    Toast.makeText(SponsorCommentActivity.this, "댓글을 입력해주세요.", Toast.LENGTH_SHORT).show();
                }
                else {
        ...
        mDatabaseRef.child("SponsorComment").child(receiveTitle).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("SponsorCommentActivity", String.valueOf(databaseError.toException())); // 에러문 출력
            }
        });
    ...
    public void addinfo(String comment, String id) {
        ...
        mDatabaseRef.child("SponsorComment").child(receiveTitle).push().setValue(info);
    }
}