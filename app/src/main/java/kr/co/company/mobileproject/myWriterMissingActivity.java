...
public class myWriterMissingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_writer_missing);
        ...
        mDatabaseRef.child("MissingAnimalInfoWriter").child(UserId).limitToLast(100).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Log.e("myWriterMissingActivity", String.valueOf(databaseError.toException()));
            }
        });

        adapter = new MyWriterMissingAdapter(arrayList, this);
