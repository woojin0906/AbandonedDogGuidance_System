...
public class AnimalAdapter extends RecyclerView.Adapter<AnimalAdapter.CustomViewHolder> {

    private ArrayList<MissingAnimalInfo> arrayList;
    private Context context;

    public AnimalAdapter(ArrayList<MissingAnimalInfo> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MissingAnimalActivity)context).startActivity(intent);
            }
        });
    }
