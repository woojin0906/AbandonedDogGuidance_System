...
public class MissingCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(comment.equals("")) {
                    Toast.makeText(MissingCommentActivity.this, "댓글을 입력해주세요.", Toast.LENGTH_SHORT).show();
                }
                else {
        ...
        mDatabaseRef.child("MissingAniamlComment").child(receiveTitle).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("MissingCommentActivity", String.valueOf(databaseError.toException())); // 에러문 출력
            }
        });
